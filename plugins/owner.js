...
async (angle, mek, m, { quoted, reply, isOwner }) => {
    try {
        ...
        await angle.updateBlockStatus(target, "block");
...
async (angle, mek, m, { from, isGroup, isAdmins, isBotAdmins, reply, quoted }) => {
    try {
        ...
        const groupMetadata = await angle.groupMetadata(from);
        ...
        await angle.groupParticipantsUpdate(from, [target], "remove");
...
async (angle, mek, m, { from, isGroup, isOwner, reply }) => {
    try {
        // Check if the command is used in a group
        if (!isGroup) return reply("⚠️ This command can only be used in a group!");
...
async (angle, mek, m, { from, isGroup, isAdmins, isBotAdmins, reply }) => {
    try {
        // Check if the command is used in a group
        if (!isGroup) return reply("⚠️ This command can only be used in a group!");
        ...
        await angle.groupSettingUpdate(from, "announcement");
...
async (angle, mek, m, { from, isGroup, isAdmins, isBotAdmins, reply }) => {
    try {
        ...
        await angle.groupSettingUpdate(from, "not_announcement");
...
async (angle, mek, m, { from, isGroup, isAdmins, isBotAdmins, reply, args }) => {
    try {
        // Check if the command is used in a group
        if (!isGroup) return reply("⚠️ This command can only be used in a group!");
        ...
        await angle.groupParticipantsUpdate(from, [target], "add");
...
async (angle, mek, m, { from, isGroup, isAdmins, isBotAdmins, reply, quoted }) => {
    try {
        ...
        await angle.groupParticipantsUpdate(from, [target], "demote");
...
async (angle, mek, m, { from, isGroup, isAdmins, isBotAdmins, reply, quoted }) => {
    try {
        ...
        await angle.groupParticipantsUpdate(from, [target], "promote");
